...
for (i in 1:num_frames) {
  ...
  betabinomial_pdf <- dbetabinom(x, 20, u * k_param[i], v * k_param[i])
  beta_pdf <- dbeta(t, shape1 = u * k_param[i], shape2 = v * k_param[i])
...
output_video <- "comparison_video_alpha_beta.mp4"
